...
malloc:     file format elf64-x86-64
...
0000000000001070 <calloc@plt>:
    ...
    1074:	f2 ff 25 55 2f 00 00 	bnd jmpq *0x2f55(%rip)        # 3fd0 <calloc@GLIBC_2.2.5>
...
0000000000001169 <main>:
    ...
    117f:	e8 ec fe ff ff       	callq  1070 <calloc@plt>
    1184:	48 89 45 f0          	mov    %rax,-0x10(%rbp)
    1188:	be 04 00 00 00       	mov    $0x4,%esi
    118d:	bf 02 00 00 00       	mov    $0x2,%edi
    1192:	e8 d9 fe ff ff       	callq  1070 <calloc@plt>
    1197:	48 89 45 f8          	mov    %rax,-0x8(%rbp)
    119b:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    119f:	c6 00 3f             	movb   $0x3f,(%rax)
    11a2:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11a6:	48 83 c0 04          	add    $0x4,%rax
    11aa:	c6 00 41             	movb   $0x41,(%rax)
    11ad:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11b1:	48 83 c0 08          	add    $0x8,%rax
    11b5:	c6 00 43             	movb   $0x43,(%rax)
    11b8:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    11bc:	48 83 c0 0c          	add    $0xc,%rax
    11c0:	c6 00 00             	movb   $0x0,(%rax)
    ...
    11db:	e8 80 fe ff ff       	callq  1060 <printf@plt>
    ...
    121d:	e8 3e fe ff ff       	callq  1060 <printf@plt>
    1222:	48 8b 45 f8          	mov    -0x8(%rbp),%rax
    1226:	48 83 c0 08          	add    $0x8,%rax
    122a:	0f b6 00             	movzbl (%rax),%eax
    122d:	0f be c0             	movsbl %al,%eax
    1230:	89 c6                	mov    %eax,%esi
    1232:	48 8d 3d cb 0d 00 00 	lea    0xdcb(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    1239:	b8 00 00 00 00       	mov    $0x0,%eax
    123e:	e8 1d fe ff ff       	callq  1060 <printf@plt>
