...
3.2.2:     file format elf64-x86-64
...
0000000000001175 <multstore>:
    ...
    117d:	e8 e7 ff ff ff       	callq  1169 <mult2>
...
0000000000001187 <main>:
    ...
    1190:	bb 28 00 00 00       	mov    $0x28,%ebx
    1195:	64 48 8b 03          	mov    %fs:(%rbx),%rax
    1199:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    119e:	31 c0                	xor    %eax,%eax
    11a0:	48 89 e2             	mov    %rsp,%rdx
    11a3:	be 03 00 00 00       	mov    $0x3,%esi
    11a8:	bf 02 00 00 00       	mov    $0x2,%edi
    11ad:	e8 c3 ff ff ff       	callq  1175 <multstore>
    11b2:	48 8b 14 24          	mov    (%rsp),%rdx
    ...
    11d1:	64 48 33 03          	xor    %fs:(%rbx),%rax
    11d5:	75 06                	jne    11dd <main+0x56>
    11d7:	48 83 c4 10          	add    $0x10,%rsp
    11db:	5b                   	pop    %rbx
    11dc:	c3                   	retq   
    11dd:	e8 7e fe ff ff       	callq  1060 <__stack_chk_fail@plt>
